...
if __name__ == '__main__':
    ...
    class CustomArguments:
        def __init__(
            ...
            wavegan_loss,
            wavegan_genr_upsample,
            wavegan_genr_pp,
            wavegan_genr_pp_len,
            wavegan_disc_phaseshuffle,
            train_batch_size,
            train_save_secs,
            train_summary_secs,
            preview_n,
            ...
            self.data_slice_len=data_slice_len
            self.data_num_channels=data_num_channels
            self.data_overlap_ratio=data_overlap_ratio
            self.data_first_slice=data_first_slice
            self.data_pad_end=data_pad_end
            self.data_normalize=data_normalize
            self.data_fast_wav=data_fast_wav
            #self.data_prefetch_gpu_num=0
            self.data_prefetch_gpu_num=data_prefetch_gpu_num
            self.wavegan_latent_dim=wavegan_latent_dim
            self.wavegan_kernel_len=wavegan_kernel_len
            self.wavegan_dim=wavegan_dim
            self.wavegan_batchnorm=wavegan_batchnorm
            self.wavegan_disc_nupdates=wavegan_disc_nupdates
            self.wavegan_loss=wavegan_loss
            self.wavegan_genr_upsample=wavegan_genr_upsample
            self.wavegan_genr_pp=wavegan_genr_pp
            self.wavegan_genr_pp_len=wavegan_genr_pp_len
            self.wavegan_disc_phaseshuffle=wavegan_disc_phaseshuffle
            self.train_batch_size=train_batch_size
            self.train_save_secs=train_save_secs
            self.train_summary_secs=train_summary_secs
            self.preview_n=preview_n
            self.incept_metagraph_fp=incept_metagraph_fp
            self.incept_ckpt_fp=incept_ckpt_fp
            self.incept_n=incept_n
            self.incept_k=incept_k

    args = CustomArguments(mode, train_dir, data_dir, data_sample_rate, data_slice_len, data_num_channels, data_overlap_ratio,
            data_first_slice, data_pad_end, data_normalize, data_fast_wav, data_prefetch_gpu_num, wavegan_latent_dim, wavegan_kernel_len,
            wavegan_dim, wavegan_batchnorm, wavegan_disc_nupdates, wavegan_loss, wavegan_genr_upsample, wavegan_genr_pp, wavegan_genr_pp_len,
            wavegan_disc_phaseshuffle, train_batch_size, train_save_secs, train_summary_secs, preview_n, incept_metagraph_fp, incept_ckpt_fp,
            incept_n, incept_k)
